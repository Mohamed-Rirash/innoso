defmodule InnosoWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: InnosoWeb.Gettext
  ...
  @doc """
  Renders a modal overlay using daisyUI dialog semantics.
  """
  attr :id, :string, required: true
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(InnosoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(InnosoWeb.Gettext, "errors", msg, opts)
    end
  end
