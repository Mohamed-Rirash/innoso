defmodule Innoso.Accounts do
  ...
  alias Innoso.Accounts.{Admin, AdminToken, AdminNotifier}
  ...
  @doc """
  Registers an admin (email only, no password — uses magic link login).
  """
  ...
  @doc """
  Creates an admin with email and password. Used for seeding and admin-panel creation.
  """
  ...
  @doc """
  Returns a changeset for admin creation (email + password).
  """
  ...
  See `Innoso.Accounts.Admin.email_changeset/3` for a list of supported options.
  ...
  See `Innoso.Accounts.Admin.password_changeset/3` for a list of supported options.
