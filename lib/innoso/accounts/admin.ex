defmodule Innoso.Accounts.Admin do
  use Ecto.Schema
  ...
  @doc """
  A changeset for creating an admin with email and password together.
  Used for seeding and admin-panel creation.
  """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Innoso.Repo)
  ...
  """
  def valid_password?(%Innoso.Accounts.Admin{hashed_password: hashed_password}, password)
