defmodule Innoso.AccountsFixtures do
  @moduledoc """
  This module defines test helpers for creating
  entities via the `Innoso.Accounts` context.
  """
  ...
  def admin_fixture(attrs \\ %{}) do
    unconfirmed_admin_fixture(attrs)
  end
  ...
  def generate_admin_magic_link_token(admin) do
    ...
    Innoso.Repo.insert!(admin_token)
